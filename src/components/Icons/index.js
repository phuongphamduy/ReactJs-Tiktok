export const MessageIcon = ({ width = '2.6rem', height = '2.6rem', className, color = 'rgba(255, 255, 255, .9)' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const InboxIcon = ({ width = '3.2rem', height = '3.2rem', className, color = 'rgba(255, 255, 255, .9)' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
